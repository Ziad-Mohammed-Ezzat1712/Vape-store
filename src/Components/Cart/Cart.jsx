    ...
    <div className="bg-black text-white min-h-screen px-6 py-10">
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="space-y-6 ">
          ...
          <div
  key={item.id}
  className="bg-[#1a1a1a] p-4 rounded-lg flex flex-col  sm:flex-row sm:items-center gap-4"
>
  <img
    src={item.image}
    alt={item.name}
  ...
  <button
    ...
    className="bg-red-600 hover:bg-red-800 px-3 py-1 rounded text-white self-center sm:self-auto"
  >
    Remove
  </button>
</div>
